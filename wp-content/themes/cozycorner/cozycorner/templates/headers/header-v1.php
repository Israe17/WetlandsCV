...
<header class="ts-header <?php echo esc_attr(implode(' ', $header_classes)); ?>">
	...
	<?php if( $cozycorner_theme_options['ts_enable_header_info'] || has_nav_menu('top_header') || $cozycorner_theme_options['ts_header_language'] || $cozycorner_theme_options['ts_header_currency'] ): ?>
		...
		<div class="header-middle">
			<div class="container">
				...
				<div class="header-left">
					...
					<?php 
					if( $cozycorner_theme_options['ts_enable_search'] ){
						cozycorner_get_search_form_by_category();
					} 
					?>
				</div>
				...
				<div class="header-right">
					...
					<?php if( class_exists('TS_Wishlist') && $cozycorner_theme_options['ts_enable_tiny_wishlist'] ): ?>
						<div class="my-wishlist-wrapper hidden-xs"><?php echo cozycorner_tini_wishlist(); ?></div>
					<?php endif; ?>
